...
ALTER TABLE "Orders"
    ADD CONSTRAINT FK_ORDER_ON_TABLE FOREIGN KEY (table_id) REFERENCES "Tables" (table_id);

ALTER TABLE "Orders"
    ADD CONSTRAINT FK_ORDER_ON_USER FOREIGN KEY (user_id) REFERENCES "Users" (user_id);

ALTER TABLE user_table
    ADD CONSTRAINT fk_usetab_on_table_entity FOREIGN KEY (table_id) REFERENCES "Tables" (table_id);
